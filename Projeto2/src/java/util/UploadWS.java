 ...
 */
@WebServlet(urlPatterns = {"/admin/produto/UploadWS", "/admin/evento/UploadWS", "/admin/animal/UploadWS", "/admin/genero/UploadWS", "/admin/admin/UploadWS", "/admin/doacao/UploadWS", "/public/voluntario/UploadWS"})
