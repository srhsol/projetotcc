        ...
        <div class="row pt-120 pb-80">
            <div class="col-lg-4 col-md-6">
                <div class="single-footer-widget">
                    <h6>Sobre nós</h6>
                    <p>
                        Somos o Projeto Cuidar, Coordenadoria do Bem-Estar Animal (CBEA), da prefeitura. 
                ...
                <div class="single-footer-widget">
                    ...
                    <div class="row">
                        ...
                        <ul class="col footer-nav">
                            ...
                            <li><a href="https://www.facebook.com/Coordenadoria-do-Bem-Estar-Animal-CBEA-342760253319943/" target="_blank">Facebook</a></li>
                        </ul>									
                    </div>
                </div>
            </div>						
