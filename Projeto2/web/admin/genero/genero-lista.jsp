        ...
        <div class="progress-table">
            ...
            <c:forEach items="${lista}" var="obj">
                <div class="table-row">
                    ...
                    <div class="nome">${obj.genero}</div>
                    <div class="visit">
                        <a class="btn btn-warning" href="GeneroWS?acao=edit&id=${obj.id}">
                            <i class="fa fa-edit"></i>
                        </a>
                    </div>
                    <div class="visit">
                        <a class="btn btn-warning" href="GeneroWS?acao=del&id=${obj.id}">
